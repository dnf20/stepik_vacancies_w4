...
companies = [
    ...
    {"id": "1", "title": "workiro", "logo": f"{MEDIA_COMPANY_IMAGE_DIR}/logo1.png", "employee_count": "10", "location": "Новосибирск", "description": "Разрабатываем мобильные приложения и сервисы для сферы онлайн-обучения."},
    {"id": "2", "title": "rebelrage", "logo": f"{MEDIA_COMPANY_IMAGE_DIR}/logo2.png", "employee_count": "24", "location": "Москва", "description": "Мобильные сервисы, программное обеспечение, веб-сайты, мобильные приложения."},
    {"id": "3", "title": "staffingsmarter", "logo": f"{MEDIA_COMPANY_IMAGE_DIR}/logo3.png", "employee_count": "123", "location": "Москва", "description": "Сервис онлайн-наблюдения за процессом сдачи экзамена с искусственным интеллектом"},
    {"id": "4", "title": "evilthreat h", "logo": f"{MEDIA_COMPANY_IMAGE_DIR}/logo4.png", "employee_count": "36", "location": "Москва", "description": "Лидирующее в России и Восточной Европе ПО для проведения вебинаров и видео-конференций."},
    {"id": "5", "title": "hirey ", "logo": f"{MEDIA_COMPANY_IMAGE_DIR}/logo5.png", "employee_count": "21", "location": "Воронеж", "description": "Телекоммуникационные и платежные сервисы, которые помогают развиваться бизнесам во всем мире."},
    {"id": "6", "title": "swiftattack", "logo": f"{MEDIA_COMPANY_IMAGE_DIR}/logo6.png", "employee_count": "79", "location": "Москва", "description": "Разработка сложных веб-сервисов и мобильных приложений"},
    {"id": "7", "title": "troller", "logo": f"{MEDIA_COMPANY_IMAGE_DIR}/logo7.png", "employee_count": "230", "location": "Санкт-Петербург", "description": "Мобильное приложение, позволяющее примерить обувь и выбрать идеальную пару всего в 3 клика"},
    {"id": "8", "title": "primalassault", "logo": f"{MEDIA_COMPANY_IMAGE_DIR}/logo8.png","employee_count": "13", "location": "Москва", "description": "Реализуем проекты любой сложности в digital-сфере" },
...
specialties = [
    ...
    {"code": "frontend", "title": "Фронтенд", "picture": f"{MEDIA_SPECIALTY_IMAGE_DIR}/specty_frontend.png"},
    {"code": "backend", "title": "Бэкенд", "picture": f"{MEDIA_SPECIALTY_IMAGE_DIR}/specty_backend.png"},
    {"code": "gamedev", "title": "Геймдев", "picture": f"{MEDIA_SPECIALTY_IMAGE_DIR}/specty_gamedev.png"},
    {"code": "devops", "title": "Девопс", "picture": f"{MEDIA_SPECIALTY_IMAGE_DIR}/specty_devops.png"},
    {"code": "design", "title": "Дизайн", "picture": f"{MEDIA_SPECIALTY_IMAGE_DIR}/specty_design.png"},
    {"code": "products", "title": "Продукты", "picture": f"{MEDIA_SPECIALTY_IMAGE_DIR}/specty_products.png"},
    {"code": "management", "title": "Менеджмент", "picture": f"{MEDIA_SPECIALTY_IMAGE_DIR}/specty_management.png"},
    {"code": "testing", "title": "Тестирование", "picture": f"{MEDIA_SPECIALTY_IMAGE_DIR}/specty_testing.png"}
